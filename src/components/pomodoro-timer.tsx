...
// Define the type for the functions exposed via the ref
export interface PomodoroTimerHandles {
...
// Use forwardRef to allow parent components to get a ref to this component's instance
export const PomodoroTimer = forwardRef<PomodoroTimerHandles, PomodoroTimerProps>(
  ({ initialElapsedTime = 0 }, ref) => {
    ...
    // Expose the getElapsedTime function via the ref
    ...
    const handleStartPause = () => {
      setStatus(prevStatus => prevStatus === 'Running' ? 'Paused' : 'Running');
    };
...
PomodoroTimer.displayName = 'PomodoroTimer'; // Add display name for forwardRef
